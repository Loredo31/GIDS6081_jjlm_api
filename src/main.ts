...
//! git commit -m "fix: CRUD de usuarios y creación de rutas paa la autenticación"

//! git commit -m "fix: Inicio de sesión completo y proteccion de rutas"

//! git commit -m "fix: Uso de custom errors y creación de logs"